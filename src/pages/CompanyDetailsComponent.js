                        ...
                        <div className="body">
                            <form onSubmit={this.formSubmit}>
                                ...
                                <button 
                                    ...
                                    >
                                    {this.state.btnMessage==0 ? "Edit Company":"Editing Company Please Wait..."}
                                </button>
                                <br/>
                    ...
                    <div className="card">
                        ...
                        {this.state.dataLoaded == false ?(
                            ...
                            <div className="header-dropdown m-r--5">
                                <button className="btn btn-info" onClick={this.AddCompanyBank}>
                                    Add Company Bank
                                </button>
                            </div>
                        </div>
                                        ...
                                        <tr key={company.id}>
                                            ...
                                            <td> 
                                                <button className="btn btn-block btn-success" onClick={()=>
                                                    this.EditCompanyBank(company.id)
                                                }>
                                                    EDIT
                                                </button>
