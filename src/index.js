...
import CompanyComponent from './pages/CompanyComponent.js';
import CompanyDetailsComponent from './pages/CompanyDetailsComponent';
import LogoutComponent from './pages/LogoutComponent.js';
...
import MedicineAddComponent from './pages/MedecineAddComponent';
import MedicineManageComponent from './pages/MedecineManageComponent';
import CompanyAccountComponent from './pages/CompanyAcountComponent';
