...
class Sidebar extends React.Component{
    ...
    constructor(props){
        super(props);
        this.drivef=React.createRef();
        this.drivef2=React.createRef();
    }
    ...
    handleMouseClick=(event)=>{
        if(event.target === this.drivef.current || event.target === this.drivef2.current){
    ...
    showLogoutMenu = () =>{
        if(this.state.defaultclassName="btn-group user-helper-dropdown"){
                ...
                <aside id="leftsidebar" className="sidebar">
                    ...
                    <div className="user-info">
                        ...
                        <div className="info-container">
                            ...
                            <div className="email">rody.ewane@example.com</div>
                    ...
                    {/* <div className="legal">
                        ...
                        <div className="copyright">
                            © 2021 - 2022
                            <a href="#"> Rody Ewane - Medical Store</a>.
                        </div>
